package com.kafka.producer.domain.entity.user;


import com.kafka.producer.domain.converter.UserGradeConverter;
import com.kafka.producer.domain.entity.BaseAllTimeEntity;
